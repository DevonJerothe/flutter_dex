...
PokeApi pokeApiFromJson(String str) => PokeApi.fromJson(json.decode(str));
...
class PokeApi {
    ...
    factory PokeApi.fromJson(Map<String, dynamic> json) => PokeApi(
        ...
        heldItems: json["held_items"] == null ? null : List<HeldItem>.from(json["held_items"].map((x) => HeldItem.fromJson(x))),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "held_items": heldItems == null ? null : List<dynamic>.from(heldItems.map((x) => x.toJson())),
        "id": id == null ? null : id,
